...
export default async function LandscapePage() {
    ...
    return (
        <div className="container py-10">
            <PageHeader
                title="ICAR Ecosystem Landscape"
                        ...
                        <Link key={org.id} href={`/organizations/${org.id}`}>
                            <Card className="p-6 hover:shadow-lg transition-shadow cursor-pointer h-full flex items-center justify-center">
                                <div className="text-center">
                                    ...
                                    <div className="w-16 h-16 mx-auto mb-3 bg-[var(--color-off-white-sea-green)] rounded-full flex items-center justify-center">
                                        <span className="text-2xl font-bold text-[var(--color-sea-green-darkest)]">
                                            {org.name.charAt(0)}
                                        </span>
                                    </div>
